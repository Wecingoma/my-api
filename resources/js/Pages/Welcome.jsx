...
export default function Welcome({ auth, posts, canRegister }) {
  return (
    <>
      <Head title="Welcome weci" />
      <div className="min-h-screen">
        <Nav />
        <div className="bg-white">
          <div className="max-w-7xl mx-0 py-16 px-4 sm:py-46 sm:px-6 lp:px-8">
            <div className="text-center">
              <h1 className="text-4xl font-black text-gray-800">
                <span className="block">Bienvenue sur App</span>
              ...
              <p className="mt-3 max-w-md mx-auto text-gray-500">
                ...
                Reiciendis, sed accusantium eaque libero cum temporibus tenetur veniam 
                perferendis eligendi, exercitationem ex facilis officiis nulla suscipit quidem recusandae
                aspernatur.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-1">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-xl">
              Découvrez les derniers articles de notre communauté, partagez vos idées et apprenez ensemble.
            </p>
          </div>
