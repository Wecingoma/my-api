...
fixed w-full z-20 top-0 start-0 border-b border-gray-200
 ...
 ">
  ...
  <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
      ...
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-blue">Brickon</span>
  </a>
    ...
    dark:bg-gray-800
     md:dark:bg-gray-400
      ...
      <li>
        ...
        rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Home</a>
      </li>
      <li>
        <a href="#" class="block py-2 px-3
